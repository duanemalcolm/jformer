...
#        if(is_string(self.validationOptions)):
#            self.validationOptions = array(self.validationOptions)
#        }
#        
#        return this
#    }
...
#            'id':self.id.'-wrapper',
#            'class':'jFormComponent '.self.class,
#        ))
#
