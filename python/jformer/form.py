...
#~     self.status = array('status':'processing', 'response':'Form initialized.')
#~     # Validation
...
#~      * Constructor
#~      */
#~     def __construct(id, optionArray = {}, jFormPageArray = {}):
#~         # Set the id
#~         self.id = id
...
#~         if (!empty(self.pageNavigator)):
#~             self.pageNavigatorEnabled = true
#~          else if (self.pageNavigator == true):
#~             self.pageNavigator = array(
#~                 'position':'top'
#~             )
#~         

#~         # Set defaults for the splash page
#~         if (!empty(self.splashPage)):
...
#~                 if (fileIdInfo[1] != null || (fileIdInfo[1] == null && array_key_exists(0, self.jFormPageArray[jFormPageId]->jFormSectionArray[jFormSectionId]->jFormComponentArray))):
#~                     # section instance
...
#~                     if (fileIdInfo[3] != null || (fileIdInfo[3] == null && is_array(self.jFormPageArray[jFormPageId]->jFormSectionArray[jFormSectionId]->jFormComponentArray[jFormSectionInstanceIndex][jFormComponentId]->value))):
...
#~                     if (fileIdInfo[3] != null || (fileIdInfo[3] == null && is_array(self.jFormPageArray[jFormPageId]->jFormSectionArray[jFormSectionId]->jFormComponentArray[jFormComponentId]->value))):
...
#~             if (id == formPageId):
#~                 self.formPageArray[formPageId] = null
#~                 array_filter(self.formPageArray)
#~                 return true
#~             
#~             foreach (formPage->formSectionArray as formSectionId:&formSection):
#~                 if (id == formSectionId):
#~                     self.formPageArray[formPageId]->formSectionArray[formSectionId] = null
...
#~                         self.formPageArray[formPageId]->formSectionArray[formSectionId]->formComponentArray[formComponentId] = null
