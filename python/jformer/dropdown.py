...
#     * Constructor
#     */
#    def __construct(id, label, dropDownOptionArray, optionArray = {}):
#        # General settings
#        self.id = id
#        self.name = self.id
#        self.class = 'jFormComponentDropDown'
#        self.label = label
#        self.dropDownOptionArray = dropDownOptionArray
#
...
#    }
#
#    static def getStateArray(selectedState = None):
...
#    }
#
#    static def getYearArray(minYear, maxYear):
#        yearArray = {}
...
#        }
#        if(self.size != None):
#            select.setAttribute('size', self.size)
#        }
#        if(self.width != None):
#            select.setAttribute('style', 'width:'.self.width)
#        }
#
#        # Check for any opt groups
#        optGroupArray = {}
#        foreach(self.dropDownOptionArray as dropDownOption):
...
#            
#                {dropDownOption['optGroup']}.insert(self.getOption(optionValue, optionLabel, optionSelected, optionDisabled))
#            }
#        }
#        
...
#                optionOptGroup =  isset(dropDownOption['optGroup']) ? dropDownOption['optGroup'] : ''
#
#                select.insert(self.getOption(optionValue, optionLabel, optionSelected, optionDisabled))
#            }
#        }
#
